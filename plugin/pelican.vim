...
command! -nargs=+ LLMCommand lua require('pelican').query_visual(<q-args>, true)
command! -nargs=0 LLMCommandPrompt lua require('pelican').query_visual(vim.fn.input({prompt = 'LLM Command: ', cancelreturn = vim.NIL}), true)
